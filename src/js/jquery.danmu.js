                    ...
                    if ($(element).data("danmuList")[$(element).data("nowTime")] && me.launched.indexOf($(element).data("nowTime")) < 0) {
                        ...
                        for (var i = (danmus.length - 1); i >= 0; i--) {
                            ...
                            if (danmaku.hasOwnProperty('isnew')) {
                                $("#" + me.id + "tempDanmaku").css({'width':'auto','border-radius':'2px','padding':'0 2px 0 2px'});
                            }
                            ...
                            if (danmaku.position == 0) {
                                ...
                                $(element).data("topSpace", options.FontSizeBig*temRow+3);
                                me.topRows[temRow]=1;
                                $("#" + topTmpId).css({
                                    "width": "100%"
                                    , "text-align": "center"
